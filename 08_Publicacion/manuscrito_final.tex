...
produjo 124 fragmentos codificados y 67 c\'odigos \'unicos; el de contraste, 89
fragmentos y 36 c\'odigos \'unicos.
...
\hline
Dominio (ENTR-01--08) & 2 & 67 \\
Contraste (ENTR-09--16) & 1 & 36 \\
\hline
\end{tabular}
\end{table}

El n\'umero de c\'odigos nuevos por entrevista descendi\'o en general en ambos estratos,
aunque con oscilaciones (en dominio, \texttt{ENTR-07} aport\'o cuatro c\'odigos nuevos y
\texttt{ENTR-08}, dos; en contraste, \texttt{ENTR-15} aport\'o cuatro y \texttt{ENTR-16}, uno).
La \'ultima entrevista de cada estrato todav\'ia aport\'o c\'odigos nuevos, por lo que estos
resultados se interpretan como una aproximaci\'on a la saturaci\'on tem\'atica y no como
saturaci\'on demostrada. Un an\'alisis de sensibilidad al orden de las entrevistas (10\,000
\'ordenes aleatorios, semilla 20260921) mostr\'o que, sobre las 16 entrevistas, la \'ultima
aporta cero c\'odigos nuevos solo en el 43,9\,\% de los \'ordenes (16,7\,\% en las dos
\'ultimas), de modo que la apariencia de saturaci\'on en el orden real depende en parte del
orden en que se realizaron las entrevistas. De los c\'odigos identificados, 21 son compartidos
entre ambos estratos y 15 aparecen \'unicamente en el estrato de contraste, para un total de
82 c\'odigos \'unicos en la vista agregada de las 16 entrevistas.
